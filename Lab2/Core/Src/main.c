...
//  xTaskCreate(USART_Test, "USART", 1000, NULL, 1, NULL);
  xTaskCreate(Red_LED_App, "Red", 1000, NULL, 1, NULL);
  xTaskCreate(Green_LED_App, "Green", 1000, NULL, 1, NULL);
  xTaskCreate(TaskMonitor_App, "Monitor", 1000, NULL, 3, NULL);
